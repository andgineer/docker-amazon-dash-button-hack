...
def test_get_credentials_success(google_api_instance, google_credentials):
    ...
    assert google_api_instance.credentials is not None
    ...
    google_api_instance.get_credentials()
...
def test_get_service_with_http(mock_build, google_api_instance):
    ...
    google_api_instance.credentials = Mock()
...
def test_get_service_without_http(google_api_instance):
    google_api_instance.credentials = None
