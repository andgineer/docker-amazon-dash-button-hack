"""
Obsolete - gspread works way too slow (10 minutes! to add two rows),
replacesed by direct manipulation thru googleapiclient (google_sheet.py)
"""
...
class Sheet:
    def __init__(self, settings):
        ...
        self.gdoc = gc.open(settings['spreadSheetName'])
